...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                // sem isso, requisição sem token (ou com token inválido/expirado) numa rota
                // protegida cai no 403 padrão de "acesso negado por papel" — o front só sabe
                // detectar sessão expirada em 401, então ficava preso numa tela quebrada em
                // vez de voltar pro login. 401 aqui é só "não autenticado"; 403 continua pro
                // caso de papel errado com token válido (AccessDeniedException, não mexido).
